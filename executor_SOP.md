...
11. **MUST** all execution of SOP in full or partial steps, must alwys end with you terminating the REPL or interactive mode by emitting appropriate commands.
...
# Final Handoff
Once you have successfully written your `executor_report.json`, you MUST execute one final shell command to signal the orchestrator to take over:
Execute: `New-Item -ItemType File -Name "handoff.trigger"`
Do not do anything else after creating this file.